...
module Shiva
  class WhiteCrystal < Action
    ...
    def crystal
      Containers.lootsack.where(name: /white crystal$/).first or
      Containers.harness.where(name: /white crystal$/).first
    end
    ...
    def available?(foe)
      return false if XMLData.room_title.include?("The Rift")
